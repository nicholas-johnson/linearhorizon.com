...
export const pages: SitePage[] = [
  ...
  },
  {
    ...
    body: [
      'Strategy, discovery and architecture from people who understand the underlying technology — and who will still be involved if you decide to build, or to deploy Platform and the specialist applications.',
    ],
  },
  {
    path: '/approach',
  ...
  },
  {
    ...
    description:
      'Production AI systems: agents, RAG, copilots and bespoke applications — or deployments of Platform and the specialist applications, designed around real organisational requirements.',
    kicker: '04 / Build',
    ...
    body: [
      'We already have productised technology: Platform and the specialist applications. Those products can be deployed, adapted and extended. They do not claim that every organisational problem fits into one application.',
  ...
  },
  {
    ...
    body: [
      ...
      'Services — Train, Advise, Build — are how we work closely with you. Products — Platform and the specialist applications — are technology we have already built, so not every engagement starts from scratch.',
  ...
  },
  {
    ...
    title: 'Contact',
    description:
      'Talk to us about training, consulting, a bespoke system, or a Platform and specialist application deployment.',
    kicker: '08 / Contact',
    headline: 'Talk to us.',
    intro: [
